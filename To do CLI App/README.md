...
1. ⌨️ Accept user input through terminal
2. 📋 Store tasks in Python lists
3. 💾 Save tasks permanently using text files
4. 📃 Display tasks using loops
5. ❌ Delete selected tasks using list operations
...
- 💡 Learned how to build terminal-based applications
...
💼 **LinkedIn:** www.linkedin.com/in/ashna-ansari